...
$OUTPUT_PATH = "/home/dave/esoachsprite/";
$ICON_BASEPATH = "/home/uesp/www/eso/gameicons";

if (php_sapi_name() != "cli") die("Can only be run from command line!");
print("Creating achievements CSS sprite...\n");
...
if ($result === false) exit("Failed to load achievements data! \n" . $db->error . "\n");
...
print("\tLoaded $rowCount achievements...\n");
