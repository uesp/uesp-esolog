...
class EsoSalesDataParser
{
	...
	public function createTables()
	{
		...
		$query = "CREATE TABLE IF NOT EXISTS guilds (
						...
						storeLocation TINYTEXT NOT NULL DEFAULT '',
						lastStoreLocTime INT UNSIGNED NOT NULL DEFAULT 0,
						description TEXT NOT NULL DEFAULT '',
						numMembers INTEGER NOT NULL DEFAULT 0,
						foundedDate INT UNSIGNED NOT NULL DEFAULT 0,
						leader TINYTEXT NOT NULL DEFAULT '',
						totalSales INT UNSIGNED NOT NULL DEFAULT 0,
						totalPurchases INT UNSIGNED NOT NULL DEFAULT 0, 
						PRIMARY KEY (id),
