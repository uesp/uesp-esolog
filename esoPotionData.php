...
$ESO_POTIONEFFECT_DATA = array(
	1 => array(
				...
				"name2" => "Drain Health",
				"potionBaseId" => 54339,
				"poisonBaseId" => 76826,  //76827
				"icon" => "resources/crafting_alchemy_trait_restorehealth.png",
				"isPositive" => true,
				"index" => 18,
				"factor1" => 1.0,
				"factor2" => 0.61538461538462,
				"factor3" => 0.41025641025641,
	...
	2 =>  array(
				...
				"name2" => "Poison Damage",
				"potionBaseId" => 44812,
				"poisonBaseId" => 76827,  //76826
				"icon" => "resources/crafting_alchemy_trait_ravagehealth.png",
				"isPositive" => false,
				"index" => 5,
				"factor1" => 1.0,
				"factor2" => 0.63636363636364,
				"factor3" => 0.41818181818182,
			),
	3 =>  array(
				"id" => 3,
				"oppositeId" => 4,
	...
	4 =>  array(
				...
				"index" => 6,
				"factor1" => 1.0,
				"factor2" => 0.60952380952381,
				"factor3" => 0.40952380952381,
			),
	5 =>  array(
				"id" => 5,
				"oppositeId" => 6,
