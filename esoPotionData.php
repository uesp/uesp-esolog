...
$ESO_REAGENT_DATA = array(
		...
		"Clam Gall" => array(
				...
				"effects" => array(ESO_POTIONEFFECT_SPELLRESIST, ESO_POTIONEFFECT_HINDRANCE, ESO_POTIONEFFECT_VULNERABILITY, ESO_POTIONEFFECT_DEFILE),
		),
		"Columbine" => array(
				"name" => "Columbine",
				"itemId" => 30164,
		...
		"Powdered Mother of Pearl" => array(
				...
				"effects" => array(ESO_POTIONEFFECT_SUSTAINRESTOREHEALTH, ESO_POTIONEFFECT_SPEED, ESO_POTIONEFFECT_VITALITY, ESO_POTIONEFFECT_PROTECTION),
		),
		"Scrib Jelly" => array(
				"name" => "Scrib Jelly",
				"itemId" => 77589,
