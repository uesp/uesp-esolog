	...
	public $COMPUTED_STATS_LIST = array(
			...
			"HealthRegen" => array(
					...
					"compute" => array(
							...
							"Mundus.HealthRegen",
							"+",
							"floor(Mundus.HealthRegen * Divines)",
							"+",
							"1 + CP.HealthRegen",
							"*",
			...
			"MagickaRegen" => array(
					...
					"compute" => array(
							...
							"Mundus.MagickaRegen",
							"+",
							"floor(Mundus.MagickaRegen * Divines)",
							"+",
							"1 + CP.MagickaRegen",
							"*",
			...
			"StaminaRegen" => array(
					...
					"compute" => array(
							...
							"Mundus.StaminaRegen",
							"+",
							"floor(Mundus.StaminaRegen * Divines)",
							"+",
							"1 + CP.StaminaRegen",
							"*",
			...
			"SpellDamage" => array(
					...
					"compute" => array(
							...
							"Mundus.SpellDamage",
							"+",
							"floor(Mundus.SpellDamage * Divines)",
							"+",
			...
			"WeaponDamage" => array(
					...
					"compute" => array(
							...
							"Mundus.WeaponDamage",
							"+",
							"floor(Mundus.WeaponDamage * Divines)",
							"+",
