...
$ESO_QUEST_DATA = array(
	...
	7271 => array(
			...
			'journal' => "Several ancient stone tablets were unearthed at a site northeast of Xul-katam in eastern Solstice. However, a dangerous Voidmother named Soulcaller reportedly now haunts the area. I need to defeat Soulcaller and retrieve the tablets.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	7269 => array(
			...
			'journal' => "Lector Volonaro asked me to enter the College of Sea and Sword and destroy the anchor fragments tearing rifts around the lodge.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
