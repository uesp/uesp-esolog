...
$ESO_QUEST_DATA = array(
	...
	6508 => array(
			'name'    => "Pledge: Castle Thorn",
			'journal' => "Urgarlag Chief-bane of the Undaunted has challenged me to explore Castle Thorn.",
			'internalName' => "u27-DUN2 Pledge",
			'zoneId' => 0,
			'zone' => "",
			'type' => 15,
		),
	...
	6518 => array(
			...
			'internalName' => "SK-GB3 Q6518 Bestow",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 1,
		),
	...
	6780 => array(
			'name'    => "The Long Game",
			'journal' => "Marcelle Dantaine asked me to help break her innocent husband Valentyn out of the Amenos Station stockade before they finish processing him and banish him into the wilds of Amenos's jungle.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6552 => array(
			...
			'journal' => "Verandis believes Rada al-Saran has set his final plan in motion. He seeks my help to put a stop to the Gray Host once and for all.",
			'internalName' => "RBC1 Q6552",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6729 => array(
			'name'    => "Guidance for Guides",
			'journal' => "A Wood Elf writer named Calonir needs help conducting research for his travel brochure. If I can provide some information on the hazards and highlights of Vvardenfell, Summerset, and lands beyond, I can earn a bit of gold for my trouble.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6706 => array(
			'name'    => "Mettle and Stone",
			'journal' => "A Dark Elf, Selveni Andalor, asked me to help him free the trapped spirits of his grandmother, Sovisa, and an Ordinator, Nilera, from the False Martyrs' Folly in the Sever.",
			'internalName' => "Q6706 Mettle and Stone",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	2660 => array(
			...
			'journal' => "Grand Warlord Sorcalin needs volunteers to capture the <<1>>.",
	...
	6786 => array(
			'name'    => "Cold Blood, Old Pain",
			'journal' => "Ember says that her friend Jhaka might have a lead about the mercenaries that took her friends all those years ago. He's in Marbruk right now, and Ember wants to go there to meet him and see what we can do to help.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6514 => array(
			...
			'internalName' => "U26-AntiqIntro-Q6514",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6766 => array(
			...
			'journal' => "The Ascendant Magus stands revealed as Count Damard Dufort. He intends to lead the Ascendant Order in an attack on All Flags Islet. Lady Arabelle needs me to help save the alliance leaders-and the hope for peace.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6572 => array(
			'name'    => "Strange Contamination",
			'journal' => "Animals in Gloomreach seem to have developed the ability to produce a strange fungal mold. The Reachfolk think magic might be at work. They want samples of the mold collected in order to study them further.",
			'internalName' => "RB-D5 Solo",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6762 => array(
			'name'    => "Buried at the Bay",
			'journal' => "I encountered a man named Ilyes Maul searching for his ancestor's lost treasure. Ilyes hired me to help him find it in Ghost Haven Bay.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6579 => array(
			'name'    => "Pledge: The Cauldron",
			'journal' => "Urgarlag Chief-bane of the Undaunted has challenged me to explore the Cauldron.",
			'internalName' => "u29-DUN2 Pledge",
			'zoneId' => 0,
			'zone' => "",
			'type' => 15,
		),
	...
	6790 => array(
			...
			'journal' => "Isobel has been asked to return to Castle Navire to speak to Knight Commander Jourvel, Aurelia's mother.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6640 => array(
			'name'    => "Prankster's Carnival",
			'journal' => "I met an Argonian named <<1>> and offered to help her pull off a prank on an unsuspecting target.",
			'internalName' => "Q6640 Prankster's Bestowal",
			'zoneId' => 0,
			'zone' => "",
			'type' => 12,
		),
	...
	6601 => array(
			'name'    => "To Burn Away Evil",
			'journal' => "The Wayward Guardians need silver ore to coat their arms and armor in order to better fight against the Gray Host. Ardanir asked me to bring him some from the Dwarven ruins of Bthar-Zel.",
			'internalName' => "Q6601 CollectSilver",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	1527 => array(
			...
			'journal' => "Arcady Charnis believes someone ordered men to plant dreugh eggs in the Dreughside neighborhood to cause the dreugh to attack.",
	...
	6461 => array(
			...
			'internalName' => "U26-DMG Hounds of Hircine",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6635 => array(
			'name'    => "Destroying What Remains",
			'journal' => "Mim-Jasa, a priest of the Clutch of Nisswo, asked me to help perform last rites for the Shadowscales who were entombed in the cave long ago. Doing so will supposedly prevent a necromancer named Tumma-Maxath from using them for his own evil purposes.",
			'internalName' => "Q6635-Bloodrun",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6591 => array(
			'name'    => "The Lost Scout's Report",
			'journal' => "I found a faded scrap of parchment in the depths of Blackreach. It's an account written by a Nord scout, Falkfyr, after he became lost in the great cavern. If I wish to discover Falkfyr's fate, I should follow the directions in his notes.",
			'internalName' => "Q6591 ScoutVoices",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6616 => array(
			...
			'journal' => "The last surviving members of the Imperial Elder Council in Blackwood have sought refuge in Leyawiin Castle. I need to determine the true nature of the threat posed by the Dark Brotherhood and how it relates to Leovic's secret.",
			'internalName' => "BW2 Dangerous Truths",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6557 => array(
			'name'    => "Wild Talismans",
			'journal' => "A liaison for the Wildblood clan, <<1>>, asked that I enter Briar Rock Ruins and retrieve talismans from Wildblood warriors who were taken prisoner by a rival clan, the Thornroot.",
			'internalName' => "RB-D1 Solo",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6171 => array(
			...
			'journal' => "If I can show that I know how to make a ring, Felarian will certify me as a jewelry crafter.",
	...
	6599 => array(
			'name'    => "The Symbol of Storihbeg",
			'journal' => "I found the body of <<1>>. It looks like he died after stealing a sacred relic from the Reach.",
			'internalName' => "Q6599 Lost Acolytes03",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6669 => array(
			'name'    => "Tome of Shadow",
			'journal' => "An Argonian named Walks-Under-Shadow asked me to retrieve something called the Nightwielder's Tome from Xi-Tsei. Retrieving the tome will help him perform the proper rites for a nisswo priest named Nesh-Tei who died trying to find it.",
			'internalName' => "Q6669 Nightwielder",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6666 => array(
			'name'    => "A Mother's Obsession",
			'journal' => "Mirri has something of a family issue. Her mother, a collector of antiquities, has gone missing. Mirri requested my assistance in finding her.",
			'internalName' => "CPN Mirri Quest 01",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 16,
		),
	...
	6721 => array(
			'name'    => "A Paralyzing Lesson",
			'journal' => "Dagonists drugged Saraathu Tong operatives-along with other prisoners-and left them outside Taupezu Azzida's lair to be eaten. I need to give the prisoners the antidote and kill Taupezu Azzida before it's too late.",
			'internalName' => "Q6721 Mantikora Group Daily 3",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 1,
		),
	...
	6584 => array(
			'name'    => "Guides to the Deep",
			'journal' => "A scout of the Ard's Stonehands spotted a strange new Dwarven automaton dropping odd beacons in a nearby cave. They want me to investigate and destroy the construct, as well as any beacons I find.",
			'internalName' => "Q6584 Group Boss2",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 1,
		),
	...
	6577 => array(
			'name'    => "Pledge: Black Drake Villa",
			'journal' => "<<1>> of the Undaunted has challenged me to explore Black Drake Villa.",
			'internalName' => "u29-DUN1 Pledge",
			'zoneId' => 0,
			'zone' => "",
			'type' => 15,
		),
	...
	6628 => array(
			'name'    => "Relics and Rumblings",
			'journal' => "<<1>> asked me to help her recover relics that belonged to a Minotaur-hunter named Phalevon the Magnificent from the partially flooded depths of Undertow Cavern. Goblins and Minotaurs infest the cave.",
			'internalName' => "Q6628 00 Undertow",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6576 => array(
			'name'    => "Burning Secrets",
			'journal' => "I found the Black Drake Villa, an old retreat for the Longhouse Emperors. The young adventurer Eveli Sharp-Arrow enlisted my help in searching for an important book hidden away inside.",
			'internalName' => "u29-DUN1 Black Drake Villa",
			'zoneId' => 0,
			'zone' => "",
			'type' => 5,
		),
	...
	6465 => array(
			...
			'internalName' => "Q6465 Casualty of Faith",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6644 => array(
			'name'    => "A Proper Blessing",
			'journal' => "Deetum-Jas's friend Leric has been having a terrible run of bad luck. He asked me to gather the components necessary to give him a proper Argonian blessing to change his fortune.",
			'internalName' => "Q6644 Vunalk Solo Daily",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6648 => array(
			...
			'journal' => "",
			'internalName' => "Q6648 Shattered Vault",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6548 => array(
			...
			'journal' => "Arana believes that her former clan knows about dark Reach magic and old prophecies. If I can find the Ghostsong clan and convince the witches to share their lore, I may learn what Lady Belain plans for the Reach.",
			'internalName' => "RB-MQ4 The Reaching Darkness",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6559 => array(
			...
			'journal' => "<<1>> charged me with finding allies to assault the harrowstorm ritual sites springing up across the Reach.",
			'internalName' => "Q6559 RB Harrowstorm Daily 2",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6547 => array(
			...
			'journal' => "Count Verandis Ravenwatch tracked Lady Belain and Rada al-Saran to a mysterious Dwarven edifice. But with the keystone in hand, our enemies have a clear advantage. Braving this ruin and learning its secrets may be our best hope of stopping them.",
			'internalName' => "RB-MQ3 The Study of Souls",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6567 => array(
			'name'    => "The Tainted Briarheart",
			'journal' => "A Reach clan called the Thornroot kidnapped members of a nearby clan, the Wildblood. Now the Thornroot intend to engage in a ritual that will turn their unwilling captives into briarhearts. I need to stop them from performing the ritual.",
			'internalName' => "RB-D2-Solo",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6471 => array(
			...
			'internalName' => "U26-BML Digging Up Trouble",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6621 => array(
			'name'    => "Shadows in the Swamp",
			'journal' => "A tribe of Argonians is at odds with a group of Imperial soldiers. The Argonians say their people are missing, and they blame the Imperials. Heem-Jas asked me to act as a mediator to figure out what's going on.",
			'internalName' => "Q6621 Start",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6604 => array(
			'name'    => "Defenders of the Reach",
			'journal' => "The Wayward Guardians fear that Gray Host forces still lurk in the halls of Nchuand-Zel beneath Markarth. They need them driven from those halls.",
			'internalName' => "Q6604 CollectSigils",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6603 => array(
			...
			'journal' => "A scout reported several Reach exiles have been taken captive by strange blind creatures in the depths of Blackreach. The Wayward Guardians want me to rescue them.",
			'internalName' => "Q6603 RescueCaptives",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6612 => array(
			'name'    => "A Mortal's Touch",
			'journal' => "A strange messenger delivered a mysterious letter from someone who calls herself the Dread Lady. I should read the letter and determine what this is all about.",
			'internalName' => "BWP1 Q6612",
			'zoneId' => 0,
			'zone' => "",
			'type' => 14,
		),
	...
	6631 => array(
			...
			'journal' => "Revus Demnevanni, a Dunmer Mage, needs help with an experiment he's performing in the ruins of Veyond.",
			'internalName' => "BW-VY Veyond",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6636 => array(
			'name'    => "The Face of Change",
			'journal' => "There are strange things afoot in the sleepy little town of Farmer's Nook, and not just the arrival of a troupe of colorful entertainers. People are vanishing, only to return somehow different.",
			'internalName' => "Q6636 TheFaceOfChange",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6655 => array(
			'name'    => "A Plea from the Flames",
			'journal' => "I met an Argonian named Malosza who told me of a brutal tribe named the Sul-Xan who invaded his home. He requested I travel to Rockgrove if I wish to lend aid.",
			'internalName' => "u30-TRI Vector*",
			'zoneId' => 1263,
			'zone' => "Rockgrove",
			'type' => 1,
		),
	...
	6643 => array(
			'name'    => "Help Wanted in Leyawiin",
			'journal' => "I found a notice that says the Chamber of Legates in Leyawiin seeks adventurers for dangerous work.",
			'internalName' => "Q6643-BW-Daily Vector",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6535 => array(
			...
			'internalName' => "Q6535 Mining Samples 3",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	...
	6414 => array(
			...
			'internalName' => "u25-DUN1 Icereach",
			'zoneId' => 0,
			'zone' => "",
			'type' => 5,
		),
	...
	4725 => array(
			'name'    => "Welcome to Cyrodiil",
			'journal' => "I entered Cyrodiil, ready to help the Covenant win the war.",
	...
	6517 => array(
			...
			'internalName' => "Q6517 GB2-Werewolf",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 1,
		),
	...
	4296 => array(
			...
			'journal' => "I died, but that was only the beginning …. I awoke in Oblivion. My body is intact, but my soul has been torn from my body. I must find a way out of this nightmare place to reclaim what was lost to me, or I will be damned for all eternity.",
	...
	6629 => array(
			'name'    => "A Visit to Elsweyr",
			'journal' => "I came across a notice about visiting Elsweyr and completing various tasks in order to receive rewards. The notice says I should speak with <<1>> once I complete the tasks.",
			'internalName' => "Q6629 Elsweyr Tourism Quest",
			'zoneId' => 1086,
			'zone' => "Northern Elsweyr",
			'type' => 12,
		),
	...
	6551 => array(
			...
			'journal' => "Lady Belain seeks a mysterious Dwarven relic called the Arkthzand Keystone for her ally, Rada al-Saran. Count Verandis wants me to find the keystone before it winds up in the hands of the Gray Host.",
			'internalName' => "RB2 - Blood of the Reach",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6818 => array(
			'name'    => "Prison Problems",
			'journal' => "An advocate from the Society of the Steadfast wants someone to travel to Whalefall, an island off the western coast of Amenos, to bring back evidence of the prisoners sent there.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6653 => array(
			'name'    => "Call of the Ruinach",
			'journal' => "Someone has summoned a Daedra known as Ghemvas the Harbinger to southern Blackwood. Locals say the Ruinach slays any who approach its lair and reaps their souls. I agreed to defeat Ghemvas and sanctify the bodies of its victims.",
			'internalName' => "Q6653 Group Boss5",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 1,
		),
	...
	6533 => array(
			...
			'internalName' => "Q6533 Mining Samples 1",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	...
	6583 => array(
			...
			'journal' => "An outsider scholar reported the presence of an unknown Dwarven construct in a nearby cave that's producing new mechanical spiders.The Ard's Stonehands asked me to destroy it and test a Dwarven rod that supposedly renders constructs docile.",
			'internalName' => "Q6583 Group Boss2",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 1,
		),
	...
	4487 => array(
			...
			'journal' => "Telenger the Artificer, a renowned sage, has come to the Falinesti Autumn Site in search of answers.",
	...
	6715 => array(
			'name'    => "A Discreet Pickup",
			'journal' => "Luna Beriel says a Gleaner operative left a shipment of goods at three drop sites in the Shambles, but they haven't been picked up yet. If those goods are left in the Shambles too long, they'll be stolen.",
			'internalName' => "Q6715 DL Solo Daily 6",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	...
	4993 => array(
			...
			'journal' => "The garrison at Bangkorai Pass asked that I deliver a message to Evermore Castle.",
	...
	6615 => array(
			...
			'journal' => "Captain Rian Liore, commander of Leyawiin's Ivory Brigade, asked me to investigate the disappearance of Councilor Jirich, a former member of the Imperial Elder Council. She may be in danger because of a deadly secret tied to the Empire's past.",
			'internalName' => "BW1 A Deadly Secret",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6785 => array(
			'name'    => "Cold Trail",
			'journal' => "Ember opened up a bit about her past. Apparently, she was part of a tight-knit group of street kids for much of her younger life until her makeshift family mysteriously vanished from Skywatch. She's determined to find them and asked for my help.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6660 => array(
			...
			'journal' => "We stopped Vandacia and saved Blackwood from Mehrunes Dagon. Now Governor Keshu wants to throw a victory celebration in the gardens behind the governor's mansion in Gideon.",
			'internalName' => "Q6660 Epilogue",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6684 => array(
			'name'    => "Pledge: Red Petal Bastion",
			'journal' => "<<1>> of the Undaunted has challenged me to explore Red Petal Bastion.",
			'internalName' => "u31-DUN1 Pledge",
			'zoneId' => 0,
			'zone' => "",
			'type' => 15,
		),
	...
	6683 => array(
			'name'    => "A Rose of Many Thorns",
			'journal' => "Weylin, a priest of Azura, claims that the Knights of the Silver Rose pillaged his temple. Though he enlisted the help of the Dremora, Lyranth, he asked for my assistance reclaiming the stolen relics for his temple.",
			'internalName' => "u31-DUN1 Red Petal Bastion",
			'zoneId' => 0,
			'zone' => "",
			'type' => 5,
		),
	...
	6716 => array(
			...
			'journal' => "An Infernium called the Unmaker and multiple Havocrels wiped out a Daedric merchant caravan. Vaveli Indavel asked me to kill the monsters and bring back some of the lost supplies.",
			'internalName' => "Q6716 Infernium Group Daily 1",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 1,
		),
	...
	6724 => array(
			...
			'journal' => "Our only clue as to the next step in Sister Celdina and the Waking Flame's plans is an encoded note we can't decipher. Both Lyranth and the Anchorite believe that we can find someone in Fargrave who can translate it for us.",
			'internalName' => "Q6724 DL2 Zone Story 2",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	...
	6596 => array(
			'name'    => "The Symbol of Hrokkibeg",
			'journal' => "I came across the body of <<1>>. She apparently died while bringing a sacred relic to a shrine in Markarth.",
			'internalName' => "Q6596 Lost Acolytes01",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6606 => array(
			...
			'journal' => "The Wayward Guardians want to cleanse a sacred shrine atop the Lost Valley Redoubt from the taint of invaders and the Gray Host.",
			'internalName' => "Q6606 CleanseShrine",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6755 => array(
			'name'    => "In Secret and Shadow",
			'journal' => "A talking skull near Death's Valor Keep is promising to give treasure to whoever helps it.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6507 => array(
			'name'    => "Blood of the Past",
			'journal' => "Gwendis arrived at Castle Thorn to investigate a story that Lady Thorn has started amassing an army. She wants to know what the lady is planning and asked me to help uncover it.",
			'internalName' => "u27-DUN2 Castle Thorn",
			'zoneId' => 4,
			'zone' => "",
			'type' => 5,
		),
	...
	6627 => array(
			...
			'journal' => "Eveli Sharp-Arrow and Lyranth the Dremora are chasing the same mystery-a secret concerning the last Longhouse Emperor, Leovic. Clues point to his steward Farrul Lupus, who hired Eveli to acquire a strange book. We need to bring it to him in Riften.",
			'internalName' => "BWP2 Q6627",
			'zoneId' => 383,
			'zone' => "Grahtwood",
			'type' => 14,
		),
	...
	6651 => array(
			'name'    => "A Reign of Frogs",
			'journal' => "I agreed to hunt down a dangerous death hopper and collect singing frogs.",
			'internalName' => "Q6651 Group Boss4",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 1,
		),
	...
	6646 => array(
			'name'    => "The Gates of Adamant",
			'journal' => "I awoke imprisoned in a strange ruin. An Elf seems willing to help me, but escaping this place may not be easy. Danger lurks around every corner, and I sense that some darkness arrived with me.",
			'internalName' => "Q6646 BW Tutorial",
			'zoneId' => 1244,
			'zone' => "Isle of Balfiera",
			'type' => 2,
		),
	3631 => array(
	...
	6654 => array(
			'name'    => "Of Stone and Steam",
			'journal' => "A savage band of Sul-Xan Argonians raided the ancient city of Rockgrove. Led by Flame-Herald Bahsei, they plan to summon something named Xalvakka. I must purge the area of these brutes and stop their plan before this creature enters our realm.",
			'internalName' => "u30-TRI Rockgrove",
			'zoneId' => 1,
			'zone' => "",
			'type' => 6,
		),
	...
	6731 => array(
			'name'    => "Robhir's Final Delivery",
			'journal' => "I came across the body of a Redguard. It looks like he was in the middle of delivering something to Nass in the House of Whims in Fargrave.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6703 => array(
			'name'    => "The Key and the Cataclyst",
			'journal' => "We recovered the relic stolen from Lyranth. It's a portal key. Before we use it to find the base mentioned in the Waking Flame letter, Lyranth wants to make preparations.",
			'internalName' => "Q6703 DLP2",
			'zoneId' => 0,
			'zone' => "",
			'type' => 14,
		),
	...
	6578 => array(
			'name'    => "Into the Deep",
			'journal' => "I arrived at an abandoned mine in Deshaan and found a young Dark Elf named Drathas and a Dremora named Lyranth. Lyranth offered a deal of gold in exchange for assisting in her search for a lockbox she cannot access.",
			'internalName' => "u29-DUN2 The Cauldron",
			'zoneId' => 0,
			'zone' => "",
			'type' => 5,
		),
	...
	3645 => array(
			'name'    => "The Sapling",
			'journal' => "<<1>> fears for the survival of the Hist Tree the Argonians transplanted from Black Marsh to Ebonheart. He thinks the Dark Elves of House Dres poisoned it, so he wants to fertilize it to encourage its growth.",
	...
	6370 => array(
			...
			'internalName' => "Holiday - Anniversary Jubilee",
			'zoneId' => 0,
			'zone' => "",
			'type' => 12,
		),
	...
	6642 => array(
			'name'    => "Glittering Lies",
			'journal' => "I encountered a projection of the Duke of Crows outside Arpenia. He and the rest of the Blackfeather Court are trapped against their will to help a mage open a connection to the Evergloam. I agreed to help the Duke free the members of the Court.",
			'internalName' => "BW Q6642 Foul Mesengers",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6789 => array(
			...
			'journal' => "A ring Isobel gave to her friend Aurelia many years ago has been stolen. The ring was a symbol of their relationship, once upon a time, but here and now the loss of the signet ring could mean trouble for Isobel's family.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	4795 => array(
			'name'    => "Scaled Captors",
			'journal' => "A Bosmer scout claims her band was ambushed by Argonian invaders. She managed to get away in the scuffle, but her allies are now captives of the Argonians.",
	...
	3948 => array(
			'name'    => "Stop the Dream",
			'journal' => "After retrieving the crystal shards, <<1>> wants me to defeat the leader of the Supernal Dreamers.",
	...
	6672 => array(
			'name'    => "Love Among the Fire",
			'journal' => "Peek-Ereel gave me a message from Governor Keshu's spymaster, Tee-Wan. Tee-Wan needs my help with a private and urgent matter.",
			'internalName' => "Q6672 LoveAmongtheFire",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6515 => array(
			...
			'internalName' => "U26-AntiqTutorial-Q6515",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6807 => array(
			'name'    => "The Sable Knight",
			'journal' => "An animated suit of armor known as the Sable Knight threatens priests on pilgrimage near Steadfast Manor. I have agreed to destroy the Sable Knight and cleanse the darkness it spreads.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6554 => array(
			'name'    => "The Dark Heart",
			'journal' => "Verandis detected a growing concentration of dark energy-Void energy-within Nighthollow Keep. Perhaps we'll find the Dark Heart somewhere within those ancient ruins.",
			'internalName' => "RB5 Q6554",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	5368 => array(
			...
			'journal' => "I accepted a contract from one of the Writ Boards, an agreement to deliver Blacksmith goods to an interested organization.",
	...
	6586 => array(
			'name'    => "Betrayal at Briar Rock",
			'journal' => "I met a hunter named Medone by Briar Rock. Hagravens of the Thornroot clan imprisoned her clan and are turning them into briarhearts. Medone wants me to free her clan and punish the Thornroot clan by destroying their briarheart tree.",
			'internalName' => "U28 BRR Delve Quest",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6459 => array(
			...
			'internalName' => "6459 Long Journey Home",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6594 => array(
			'name'    => "A Charitable Contribution",
			'journal' => "I accepted a contract to craft supplies using woodworking for civilians displaced by the Three Banners War.",
			'internalName' => "MWRIT Imperial New Life WW Gr",
			'zoneId' => 0,
			'zone' => "",
			'type' => 4,
		),
	...
	6625 => array(
			'name'    => "A Keep's Ransom",
			'journal' => "The Ivory Brigade garrison of Borderwatch has been taken over by a hostile mercenary force called the Painted Eye, which is holding a number of civilians hostage.",
			'internalName' => "BW-BW Borderwatch",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6633 => array(
			...
			'journal' => "Adrahawn, an unusual Wood Elf with a passion for trees, claims that he is searching for an otherworldly seed rumored to be lost in the ruins known as the Silent Halls. I agreed to help him retrieve it.",
			'internalName' => "U30 Silent Halls Quest",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6626 => array(
			'name'    => "Competition and Contracts",
			'journal' => "I found Bastian Hallix tied up outside of Deepscorn Hollow. He asked me to help him rescue Quistley Silvelle, the son of his employers. And he warned me about a mysterious Dark Elf who entered the cave ahead of us.",
			'internalName' => "BW_Q6626 Companion Intro",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6650 => array(
			'name'    => "Rites of the Sul-Xan",
			'journal' => "The Sul-Xan Argonians are a tribe of vicious cultists who kidnap people around Blackwood for human sacrifice. I agreed to rescue captives held by the Sul-Xan and eliminate the cultists.",
			'internalName' => "Q6650 Group Boss3",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 1,
		),
	...
	3993 => array(
			...
			'journal' => "I met a group of Dark Elves in the Fungal Grotto. They want to reach a shrine within the caves. A tribe of hostile Goblins occupies most of the area, pushing out a colony of dreugh. The two fighting sides block access to the rest of the cave.",
	...
	5751 => array(
			...
			'journal' => "Outside the school of blades called Rahni'Za, I encountered an initiate of the school who told me that the Sword-Disciples have been turned into thralls by a traitor. This betrayer now hides in the cavern at the end of the school's five trials.",
	...
	6460 => array(
			...
			'internalName' => "Q6460 IceandDeath",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	4028 => array(
			...
			'journal' => "The Daggerfall Covenant has seized control of Foyen Docks. An injured Argonian fisherman saw Rana fighting through their ranks.",
	...
	6468 => array(
			...
			'internalName' => "SK-KH Q6468 Karthwatch",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6770 => array(
			...
			'journal' => "A corruption has upset the natural balance of Stonelore Grove, turning the creatures there aggressive. Druid Audrine asked me to assist her in removing the corruption and discovering its source before it spreads to the rest of the island.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6664 => array(
			'name'    => "Family Secrets",
			'journal' => "Bastian recently learned that he was never supposed to stay with the Silvelles. He should have been taken in by his older sister Clairene, who is married to Count Auzin of Wayrest. Bastian wants to find out what happened.",
			'internalName' => "CPN Bastian 02",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 16,
		),
	...
	4424 => array(
			...
			'journal' => "<<1>> wants an Imperial lieutenant killed, to hurt their army's morale and readiness.",
	...
	6492 => array(
			...
			'internalName' => "Q6492-SK-Daily Vector",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	...
	6491 => array(
			...
			'internalName' => "Q6491 Chillwind Depths",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6500 => array(
			...
			'internalName' => "Q6500 Labyrinthian PD Quest",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	4066 => array(
			...
			'journal' => "A giant bear named <<1>> has been attacking travelers near Vlastarus.",
	...
	6674 => array(
			...
			'journal' => "According to <<1>>, a group of Naga extremists in Xi-Tsei called Sul-Xan are capturing and sacrificing innocent people. His client wants me to infiltrate the temple and destroy the extremists' ritual tools, then return for my reward.",
			'internalName' => "Q6674 Xanmeer Overlook Solo",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6764 => array(
			...
			'journal' => "We have corroborating evidence that High King Emeric, Queen Ayrenn, and Prince Irnskar may have washed ashore on the prison island of Amenos. Lady Arabelle has a plan for rescuing them.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6774 => array(
			...
			'journal' => "Brokerock Mine is being attacked by creatures called Hadolids. Meryline Barthel asked me to help her deal with the Hadolids in the mine.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6696 => array(
			...
			'journal' => "Lyranth thinks we need to find the Fourth Ambition and gather up Sombren and Calia before Mehrunes Dagon goes after them and launches his next plot to conquer Nirn. She has once again asked me to help her.",
			'internalName' => "DLC1 Start",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	...
	6484 => array(
			...
			'internalName' => "U26-MKG A Clan Divided",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6472 => array(
			...
			'internalName' => "SK-CK Q6472 Lady of Blood",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6558 => array(
			'name'    => "Halt the Harrowstorms",
			'journal' => "<<1>> charged me with finding allies to assault the harrowstorm ritual sites springing up across the Reach.",
			'internalName' => "Q6558 RB Harrowstorm Daily",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6562 => array(
			...
			'journal' => "<<1>> asked me to look for her husband, <<2>>, and their pet bunny <<3>>. She thinks they might be lost in the Reach.",
			'internalName' => "Q6562 Lost in The Reach",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6590 => array(
			'name'    => "Vows and Oaths",
			'journal' => "The Reach clans Six-Fords and Eagleseers don't get along. They plan to rectify that through the marriage of two of their young members, Eslyn and Madearn. A handfasting rite must be performed to announce their intention to marry.",
			'internalName' => "Q6590 Vows and Oaths",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6475 => array(
			...
			'internalName' => "Q6475 D1 Midnight Barrow",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	...
	6622 => array(
			'name'    => "A Foe Most Porcine",
			'journal' => "I received an invitation from Jester King Emeric to enter some kind of competition at the Hammerdeath Arena in Stormhaven.",
			'internalName' => "Q6622 King Boar Invitational",
			'zoneId' => 0,
			'zone' => "",
			'type' => 12,
		),
	...
	6509 => array(
			...
			'internalName' => "Q6509 GB1-Sea Giant",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 1,
		),
	...
	6532 => array(
			...
			'internalName' => "Q6532 Player Guild Vector",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6541 => array(
			...
			'journal' => "The battle for the Imperial City surges once more. I should see if I can lend my strength to my alliance.",
			'internalName' => "Q6541 Start",
			'zoneId' => 584,
			'zone' => "Imperial City",
			'type' => 12,
		),
	...
	6561 => array(
			'name'    => "Veteran Vateshran's Rites",
			'journal' => "The Rites Matron challenged me to complete the Vateshran's Rites within Vateshran Hollows. My success determines whether I earn the right to stay in the Reach.",
			'internalName' => "DUN-VR Vateshran'sRites Vet",
			'zoneId' => 1227,
			'zone' => "Vateshran Hollows",
			'type' => 5,
		),
	4322 => array(
			'name'    => "Lost Crown",
	...
	6723 => array(
			...
			'journal' => "I met a mysterious woman who calls herself the Anchorite. A strange magic connects us that may have something to do with Lyranth the Dremora. The Anchorite asked me to help her find Lyranth and investigate the Order of the Waking Flame in Fargrave.",
			'internalName' => "Q6723 DL1",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6771 => array(
			'name'    => "Tower Full of Trouble",
			'journal' => "Strange magic is causing chaos around Tor Draioch. I need to investigate it and put a stop to it before it hurts anyone.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6663 => array(
			'name'    => "Vinnus's Research",
			'journal' => "I found the corpse of Vinnus Reburrus next to an unsettling stone in the Deadlands. His last note said the mysterious stone was linked to Mehrunes Dagon's plans.",
			'internalName' => "Q6663 Dead Guy",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6787 => array(
			...
			'journal' => "Ember still hopes to find the last member of her found family, Song. Silverslip and Jhaka have been investigating her whereabouts and apparently attracted the attention of a merchant in Evermore, a city in Bangkorai. That might be our next lead.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6698 => array(
			'name'    => "Reformatory Rescue",
			'journal' => "A Khajiit named Tufeh asked me to enter the Brandfire Reformatory, a Waking Flame cult stronghold. Her sister, Pibiha, was taken inside by cultists and Tufeh doesn't know what happened to Pibiha.",
			'internalName' => "Q6698 Indoctrination Intima",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6727 => array(
			'name'    => "Salvaged Plans",
			'journal' => "A member of the Grasp named Zyr asked me to help track down a group of thieves who stole a large quantity of Redmaiden from Fargrave. Apparently, they fled to the Sever after leaving Fargrave.",
			'internalName' => "DL-IC1 Lost Salvagers",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	...
	6730 => array(
			'name'    => "Courier's Folly",
			'journal' => "I found the body of a Spiderkith, Telofasa. It looks like she died while attempting to deliver something.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6758 => array(
			'name'    => "A Sheep in Need",
			'journal' => "Moric Guidroz believes that a group of Hadolids stole his prized sheep, Privette. They carried her into their lair at Breakwater Cave.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6791 => array(
			'name'    => "The Princess Detective",
			'journal' => "Isobel received another letter from Knight Commander Jourvel, wanting to chat. My companion believes it has to do with Aurelia and her pursuit of that mysterious conspiracy in Rivenspire.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6806 => array(
			...
			'journal' => "The Tales of Tribute tournament begins now! If I succeed in defeating all of my opponents, I will advance to the second round, bringing me closer to the title match.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6822 => array(
			'name'    => "A Special Reagent",
			'journal' => "An alchemist requested brine glands from molting Hadolids. There's a Hadolid molting ground on Amenos, guarded by a fierce Hadolid matron. If I want to get brine glands, I'll have to deal with the matron.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6826 => array(
			'name'    => "Druidic Research",
			'journal' => "A mage studying the practices of druidic magic needs someone to collect ritual components from Coral Cliffs on Amenos to help advance their research.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	4668 => array(
			'name'    => "Lizard Racing",
			'journal' => "I'm now participating in Lizard Racing, where I place bets on which lizard finishes the race first.",
	...
	4683 => array(
			...
			'journal' => "<<1>> needs herbs delivered to <<2>> in Bruma.",
	...
	6563 => array(
			...
			'journal' => "A strange and powerful storm disrupted the protective wards around the village of Karthwasten, turning a portion of its people feral. Apprentice Fialyn needs help restoring the wards.",
			'internalName' => "Q6563 Karthwasten",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	4719 => array(
			...
			'journal' => "I saved Dune from the plots of Javad Tharn. Now I must aid the Lunar Champion as she walks the Two Moons Path, a mystical Khajiit ritual used to anoint a new Mane.",
	...
	6474 => array(
			...
			'internalName' => "Q6474 Shadowgreen",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 1,
		),
	...
	5464 => array(
			...
			'journal' => "A group of Orc artisans were heading to the new city of Orsinium when they were attacked by members of the Trinimac cult known as the Vosh Rakh and taken prisoner in the ruins of Paragon's Remembrance.",
	...
	6647 => array(
			'name'    => "Dog Days",
			'journal' => "I found a note by the corpse of an Imperial. His dying wish was for his love to know the truth about what happened to him.",
			'internalName' => "Q6647 Dead Guy",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6506 => array(
			'name'    => "Pledge: Stone Garden",
			'journal' => "<<1>> of the Undaunted has challenged me to explore Stone Garden.",
			'internalName' => "u27-DUN1 Pledge",
			'zoneId' => 0,
			'zone' => "",
			'type' => 15,
		),
	...
	6728 => array(
			'name'    => "A Gem of a Mystery",
			'journal' => "I found the body of a Scamp alongside a note and bag in the Deadlands.",
			'internalName' => "Q6728 Dead Guys Note",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	...
	6738 => array(
			'name'    => "Web of Lies",
			'journal' => "The legendary mage, Divayth Fyr, came to Fargrave in search of a powerful Daedric artifact called the Ebony Blade. However, the owners hid it away under mysterious circumstances. I agreed to help Divayth uncover the truth of the missing sword.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6756 => array(
			'name'    => "Pursuit of Freedom",
			'journal' => "Louna Jolvanne, a Breton prisoner on Amenos, wants to rescue her partner Anton from Whalefall. The jailers hunt prisoners there as a game. The promised reward for survival is freedom from Amenos.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6750 => array(
			'name'    => "Honest Toil",
			'journal' => "Fasaria, a devotee of Zenithar, told me that completing deeds for Zenithar would earn his favor on this holiday.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6744 => array(
			'name'    => "The Force of Change",
			'journal' => "I encountered Valsirenn trapped in a sychroseisiac state, out of phase with reality and in need of assistance. She asked me to help her locate a sage named Master Rrvenk, who is supposed to be a master of the Eleventh Force: Change.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6760 => array(
			'name'    => "Tournament of the Heart",
			'journal' => "Knight Commander Jourvel has promised the hand of her daughter Aurelia in marriage. Isobel Veloise, a Knight Aspirant in the Sapphire Tourney, has sworn to free Aurelia from her mother's promise.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6776 => array(
			'name'    => "The Large Delegate",
			'journal' => "<<1>>, delegate-at-large for the Ebonheart Pact Cultural Exchange, misplaced his scepter of office after a night of wild festivities. He asked me to help him find it.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6671 => array(
			'name'    => "Shrine of Nocturnal",
			'journal' => "The Daedric Prince, Nocturnal, tasked me with recovering a relic that was stolen from her shrine.",
			'internalName' => "Q6671 Shrine of Nocturnal",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6804 => array(
			'name'    => "A New Venture",
			'journal' => "Now that I'm an official member of the Roisters Club, Master Razhamad wants me to gain some experience playing Tribute.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6792 => array(
			...
			'journal' => "I found the body of a Khajiit, <<1>>. It looks like he died on the way to deliver something to the Dufort Shipyards.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6673 => array(
			...
			'journal' => "<<1>> asked me to collect crow eggs from <<2>> for two potential clients. One client wants the eggs saved, and the other wants them destroyed. It's up to me to decide what to do.",
			'internalName' => "Q6673 Arpenia Solo Daily",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6687 => array(
			'name'    => "Bounties of Blackwood",
			'journal' => "",
			'internalName' => "Q6687 Bounties of Blackwood In",
			'zoneId' => 0,
			'zone' => "",
			'type' => 12,
		),
	...
	6814 => array(
			...
			'journal' => "A woman named Genalda enlisted my help gathering ingredients for a new drink she and her partner, Hilgrim, are hoping to make. Apparently, Hilgrim drank the last of their stock.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6685 => array(
			'name'    => "Quaking Dread",
			'journal' => "I met a pair of Imperial Battlemages named Martus and Lucilla outside an abandoned prison known as the Dread Cellar. Martus asked for my help investigating magical activity that caught the Battlespire's notice.",
			'internalName' => "u31-DUN2 The Dread Cellar",
			'zoneId' => 0,
			'zone' => "",
			'type' => 5,
		),
	...
	6808 => array(
			'name'    => "Wildhorn's Wrath",
			'journal' => "A dangerous faun lord called Glemyos Wildhorn kills any hunters who enter its territory. Recently, Wildhorn slaughtered a band of noble hunters. The bloodshed must stop.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6701 => array(
			'name'    => "An Apocalyptic Situation",
			'journal' => "A strange messenger claims that someone she calls the Dread Lady wants to meet with me. She further claims that this involves a situation that could have apocalyptic consequences.",
			'internalName' => "DLP01 Quest Start",
			'zoneId' => 0,
			'zone' => "",
			'type' => 14,
		),
	...
	6824 => array(
			'name'    => "Challenges of the Past",
			'journal' => "The second Tribute tournament is about to begin! Unfortunately, Sorinne's past threatens to derail her future in the upcoming matches. The Gonfalon Chapter needs her help to succeed, but she may need our help to overcome her demons.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6705 => array(
			'name'    => "Death Stalks the Weak",
			'journal' => "An Orc named Khazasha plans to enter the Daedric citadel called Ardent Hope. She tracked a Daedric creature called the Ravener inside and plans to destroy it for murdering her entire clan.",
			'internalName' => "Q6705 Ardent Hope Objective",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6699 => array(
			'name'    => "Deadlight",
			'journal' => "We destroyed the Riven Cataclyst at Fort Grief, but Sister Celdina escaped. We believe she retreated to a hidden stronghold in a forgotten realm known as Deadlight. We need to find this realm and deal with the cult once and for all.",
			'internalName' => "U32-Q6699-DL5",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	...
	6719 => array(
			'name'    => "Careless Contamination",
			'journal' => "Taupezu Azzida, a Mantikora in the Sever, poisons its prey. The Saraathu Tong wants to study the Mantikora's victims to make an antidote out of the venom. They want the Mantikora killed so no one can use the venom to harm mortals.",
			'internalName' => "Q6719 Mantikora Group Daily 1",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 1,
		),
	...
	6749 => array(
			...
			'journal' => "Amminus Varo, a priest of Zenithar, asked me to help him make an offering to Zenithar and recover the blessed awl, a sacred object which was stolen.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6769 => array(
			...
			'journal' => "Brusic, a sentry for House Mornard, asked me to find Veslyn, another sentry sailing with him, and the prisoners in their care. Brusic followed their footprints, but they disappeared into the Coral Cliffs after Brusic's ship wrecked.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6763 => array(
			'name'    => "Spies in the Shallows",
			'journal' => "Titus Stolo requested my aid in dealing with some intelligence he claims is important to my alliance that was lost when Dreadsail pirates interrupted their recovery from vessels that crashed into Shipwreck Shoals.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6801 => array(
			'name'    => "Dueling Tributes",
			'journal' => "The Gonfalon Bay Club is offering rewards for any Tales of Tribute players who can win matches against other members of the club.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6795 => array(
			...
			'journal' => "I helped Captain Eshmadin gather the lost fragments of a treasure map. Now he asked me to help him collect the treasure.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6815 => array(
			...
			'journal' => "House Dufort needs someone to enter Breakwater Cave on the southern coast of High Isle and destroy the crates of supplies stolen by the Hadolids that reside there.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6829 => array(
			...
			'journal' => "I reached the final round of the Tribute Tournament! I will have to summon up all my skill to win the title and take my place as a Tribute Master.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6821 => array(
			'name'    => "Ascendant Shadows",
			'journal' => "Two Ascendant Order fanatics threaten travelers in western High Isle. The Ascendant Executioner and the Ascendant Harrower capture their victims with dark magic and subject them to horrible torment.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6720 => array(
			'name'    => "Retrieval Gone Awry",
			'journal' => "A previous group of heroes left the Saraathu Tong's liminal rods in a Mantikora's lair. Vaveli Indavel tasked me with destroying the rods and killing Taupezu Azzida, the Mantikora.",
			'internalName' => "Q6720 Mantikora Group Daily 2",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 1,
		),
	...
	6768 => array(
			'name'    => "Blood, Books, and Steel",
			'journal' => "I met with a squire named Rayan who fears for his knight, Dame Madach. Rayan asked if he could accompany me into the tower called the Spire of the Crimson Coin to find his missing knight.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	5374 => array(
			'name'    => "Clothier Writ",
			'journal' => "I accepted a contract from one of the Writ boards, an agreement to deliver Clothier goods to an interested organization.",
	...
	6668 => array(
			'name'    => "Beauty Amid Danger",
			'journal' => "Deetum-Jas asked me to take notes on things I observe inside a Daedric ruin for a local poet who is looking for inspiration.",
			'internalName' => "Q6668 Vault Solo Daily",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6793 => array(
			'name'    => "Ferone's Map Fragment",
			'journal' => "I found the body of a Dark Elf, <<1>>. It looks like she died on the way to deliver something to the Dufort Shipyards.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6809 => array(
			...
			'journal' => "A mage needs someone to enter the Firepot, a cave to the southwest of All Flags Islet, to help with some sort of arcane research.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6700 => array(
			...
			'journal' => "We defeated Sister Celdina, but Valkynaz Nokvroz captured the Anchorite. He wants to use her blood as fuel for his own cataclyst device. Lyranth thinks Nokvroz is holding her in his fortress, Ardent Hope. We need to rescue her.",
			'internalName' => "U32-Q6700-DL6",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	...
	6825 => array(
			...
			'journal' => "Pirates from Shipwreck Shoals have stolen crates of uniforms from alliance ships that crashed along the coastlines between High Isle and Amenos. An agent representing all the alliances wants the uniforms found and destroyed.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6732 => array(
			'name'    => "Uxark's Treasure",
			'journal' => "Nass told me that the planestones I brought to her open a portal to the hidden and valuable treasure of Uxark, a Xivilai warrior.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6796 => array(
			'name'    => "The All Flags Curse",
			'journal' => "Stibbons has asked me to help him free his mistress, Lady Clarice Laurent, from a curse that plagues All Flags Islet. Apparently, this site was once a monument dedicated to the All Flags Navy, but it has fallen into disrepair.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6812 => array(
			'name'    => "Venting the Threat",
			'journal' => "Druid Peeska is worried about the increasing activity at the volcanic vents on the island. She hired me to gather allies and disrupt the activity before the volcanic vents can erupt and the situation becomes dire.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6473 => array(
			...
			'internalName' => "SK-DB Crisis of Reach",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6505 => array(
			...
			'journal' => "Gwendis is investigating the schemes of a mad alchemist named Arkasis and his secret laboratory known only as the Stone Garden. I agreed to help Gwendis discover what Arkasis is up to and stop him if necessary.",
			'internalName' => "u27-DUN1 Stone Garden",
			'zoneId' => 4,
			'zone' => "",
			'type' => 5,
		),
	...
	6553 => array(
			'name'    => "Help Wanted in Markarth",
			'journal' => "A notice indicates that someone seeks adventurers in Markarth for dangerous work.",
			'internalName' => "Q6553-RB-Daily Vector",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	...
	6585 => array(
			'name'    => "Discarded Treasures",
			'journal' => "A scout of the Ard's Stonehands encountered a new type of Dwarven automaton in a nearby cave that appeared to be dropping scrap metal. The Stonehands asked me to investigate. I need to destroy the construct and gather the scrap.",
			'internalName' => "Q6585 Group Boss2",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 1,
		),
	...
	6617 => array(
			...
			'journal' => "The presence of the Ambitions in Gideon has painted a target on the city. I need to find a way to keep Sombren, Calia, and Destron safe while also drawing the danger away from Gideon.",
			'internalName' => "BW5",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6649 => array(
			'name'    => "Goblin Research",
			'journal' => "The Toad-Tongue Goblin tribe took over an old ruin. And they ate a scholar who ventured in to study them. I agreed to confront War Chief Zathmoz and recover any notes I can find.",
			'internalName' => "Q6649 Group Boss2",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 1,
		),
	...
	6588 => array(
			...
			'journal' => "<<1>> told me about the Old Life tradition in which people write messages to those that have passed on and burn them at special shrines.",
			'internalName' => "Q6588 - Event - Old Life",
			'zoneId' => 0,
			'zone' => "",
			'type' => 12,
		),
	...
	6565 => array(
			'name'    => "By Love Betrayed",
			'journal' => "Adusa-daro needs my help to rescue her friend Kathad from a clan of evil vampires known as the Lothid, and their leader, Boss Trenlor.",
			'internalName' => "Q6565 Halls of the Betrayed",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6581 => array(
			'name'    => "Notes of the Void",
			'journal' => "A defector from a local Reach clan informed the Ard's Stonehands that his clan's witch matron is attempting a dangerous ritual. I agreed to investigate and put a stop to the ritual, as well as search for any of the witch matron's notes.",
			'internalName' => "Q6581 Group Boss1",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 1,
		),
	...
	6638 => array(
			'name'    => "Sand, Snow, and Blood",
			'journal' => "I found a notice about traveling to Craglorn, the Wrothgar Mountains, and the Imperial City. If I complete tasks in these places, I will be rewarded.",
			'internalName' => "Q6638 Year One Tourism Quest",
			'zoneId' => 684,
			'zone' => "Wrothgar",
			'type' => 12,
		),
	...
	6014 => array(
			...
			'internalName' => "Event - Whitestrake's Mayhem",
			'zoneId' => 3,
			'zone' => "Glenumbra",
			'type' => 12,
		),
	...
	6527 => array(
			...
			'internalName' => "Q6527 GB6-Colossus",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 1,
		),
	...
	6416 => array(
			...
			'internalName' => "u25-DUN2 Unhallowed Grave",
			'zoneId' => 0,
			'zone' => "",
			'type' => 5,
		),
	...
	6597 => array(
			...
			'journal' => "A Reachman named Angair challenged me to complete a clan ritual called the Vateshran's Rites. He says it involves combat against creatures from Oblivion.",
			'internalName' => "u28-AR1 Vector",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 1,
		),
	...
	6496 => array(
			...
			'internalName' => "Q6496 Frozen Coast",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	...
	6512 => array(
			...
			'internalName' => "Q6512 SK Harrowstorm Daily",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	...
	6337 => array(
			'name'    => "A Battle of Silk and Flame",
			'journal' => "A Redguard warrior, Khud af-Hadajja, requested my help in destroying a Daedric device inside a mysterious doomvault before either the servants of Mephala or Mehrunes Dagon get their hands on it.",
			'internalName' => "Q6337 Oblivion Vault",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6353 => array(
			...
			'journal' => "Word has spread that the Divine Alkosh has descended to his mountain temple of Sunspire to be the Khajiit's savior in these troubled times.",
	...
	6466 => array(
			...
			'internalName' => "Q6466 SK4 VampireScholar",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	...
	6497 => array(
			...
			'internalName' => "Q6497 - The Tones of the Deep",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	...
	6526 => array(
			...
			'internalName' => "Q6526 GB5-Bloodknight",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 1,
		),
	6528 => array(
			'name'    => "Halt the Harrowstorms",
			'journal' => "<<1>> charged me with finding allies to assault the harrowstorms forming around Western Skyrim.",
			'internalName' => "Q6528 SK Harrowstorm Daily 2",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	6534 => array(
			...
			'internalName' => "Q6534 Mining Samples 2",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	6536 => array(
			...
			'internalName' => "Q6536 Mining Sample Finale",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	6538 => array(
			...
			'internalName' => "Q6538 Mining Samples 4",
			'zoneId' => 1160,
			'zone' => "Western Skyrim",
			'type' => 0,
		),
	6550 => array(
			...
			'journal' => "Count Verandis Ravenwatch seeks to uncover a plot to conquer the Reach by an army of vampires and werewolves that calls itself the Gray Host. To succeed, he needs to earn the trust of the region's sovereign: the dreaded Despot of Markarth.",
			'internalName' => "RB1 - The Despot of Markarth",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6555 => array(
			'name'    => "The Gray Council",
			'journal' => "Gwendis and I discovered a letter from Rada al-Saran to her mentor, Verandis, in a hidden room in Ravenwatch Castle. She asked me to accompany her to investigate the secret island, Grayhome, and the Gray Host castle mentioned in the letter.",
			'internalName' => "RBP2",
			'zoneId' => 0,
			'zone' => "",
			'type' => 14,
	...
	6556 => array(
			'name'    => "Namira's Perversions",
			'journal' => "The Ard's Stonehands are concerned about a witch matron of a rogue Reach clan attempting a dangerous ritual. I need to put a stop to this ritual and rescue the innocent Reachfolk that were abducted to carry it out",
			'internalName' => "Q6556 Group Boss1",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 1,
		),
	6560 => array(
			'name'    => "Kingdom of Ash",
			'journal' => "Rada al-Saran used the orrery to reach his sanctuary realm in Oblivion, where he will perform the Darkstorm ritual that will destroy the Reach and make the Gray Host truly immortal. To stop him, we must follow him into the Void.",
			'internalName' => "RBC2 Q6560",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6564 => array(
			'name'    => "Glory of the Undaunted",
			'journal' => "",
			'internalName' => "Q6564 Undaunted Vector",
			'zoneId' => 3,
			'zone' => "Glenumbra",
			'type' => 12,
		),
	6566 => array(
			...
			'journal' => "The Dark Heart has awakened and grows more powerful with every beat. While Verandis attempts to deal with Rada al-Saran, I need to go to Markarth and stop Lady Belain from sacrificing the entire city to the Void.",
			'internalName' => "RB6 Feast of Souls",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6569 => array(
			'name'    => "What's Hers is Ours",
			'journal' => "<<1>> explained that his contacts in the Wildblood clan think a hagraven matron is influencing the Thornroot clan. I need to take a powerful totem in her possession in order to weaken her.",
			'internalName' => "RB-D3-Solo",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6570 => array(
			'name'    => "Second Chances",
			'journal' => "Rada al-Saran is dead and the victims of the Gray Host's assault on Markarth have been restored to life thanks to Verandis.",
			'internalName' => "RBC3 Q6570",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6573 => array(
			'name'    => "Unhatched Menace",
			'journal' => "A crazed mage performing experiments in Gloomreach has a strange egg that has the potential to be dangerous if it hatches. I volunteered to destroy the egg.",
			'internalName' => "RB-D6-Solo",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6575 => array(
			'name'    => "Endeavor in the Gloom",
			'journal' => "I met a recent recruit of the Psijic Order. He asked for my help investigating strange behavior in the local plant life, which he fears may be a result of his own errant magic. I agreed to accompany him into the cave to take a closer look.",
			'internalName' => "U28 Gloomreach Delve QStart",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6582 => array(
			'name'    => "Ruptures in the Reach",
			'journal' => "The Ard's Stonehands asked me to investigate a Reach clan's witch matron and put a stop to a dangerous ritual. Supposedly, the ritual creates tears in reality. I also need to close any I find.",
			'internalName' => "Q6582 Group Boss1",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 1,
		),
	6589 => array(
			'name'    => "Red Eagle's Song",
			'journal' => "Lyris Titanborn requested my assistance. She found something at the Reachwind Ritual Site and needs help solving a problem.",
			'internalName' => "Q6589 SaiLyris",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6592 => array(
			'name'    => "A Charitable Contribution",
			'journal' => "I accepted a contract to craft supplies using blacksmithing for civilians displaced by the Three Banners War.",
			'internalName' => "MWRIT Imperial New Life BS Wh",
			'zoneId' => 0,
			'zone' => "",
			'type' => 4,
		),
	6593 => array(
			'name'    => "A Charitable Contribution",
			'journal' => "I accepted a contract to craft supplies using the clothier craft for civilians displaced by the Three Banners War.",
			'internalName' => "MWRIT Imperial New Life CL Wh",
			'zoneId' => 0,
			'zone' => "",
			'type' => 4,
		),
	6595 => array(
			'name'    => "A Charitable Contribution",
			'journal' => "I accepted a contract to craft supplies using provisioning for civilians displaced by the Three Banners War.",
			'internalName' => "MWRIT Imperial New Life PR Gr",
			'zoneId' => 0,
			'zone' => "",
			'type' => 4,
		),
	6598 => array(
			'name'    => "The Symbol of Gulibeg",
			'journal' => "I came across the body of <<1>>. He apparently died after stealing a sacred relic of Hircine bound for a shrine in Markarth.",
			'internalName' => "Q6598 Lost Acolytes02",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6600 => array(
			'name'    => "Remnants of the Deep Folk",
			'journal' => "The Wayward Guardians need Dwarven scrap to augment their arms and armor. Ardanir asked me to search the ruins of Bthardamz for the precious metal.",
			'internalName' => "Q6600 CollectScrap",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6602 => array(
			'name'    => "The Light of Arkthzand",
			'journal' => "The shamans of the Wayward Guardians claim that certain Dwarven constructs contain gemstones imbued with powerful magic. Ardanir wants me to acquire some of these gemstones.",
			'internalName' => "Q6602 CollectGemstones",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6605 => array(
			'name'    => "The Language of the Night",
			'journal' => "The Wayward Guardians seek writings from Nighthollow Keep so their witches can learn more about the magic of the Nighthollow vampires.",
			'internalName' => "Q6605 CollectScrolls",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6609 => array(
			'name'    => "The Symbol of Uricanbeg",
			'journal' => "High Shaman Glynroch sent Apprentice Orla to find the Symbol of Uricanbeg, the final sacred relic needed to dedicate the shrine, at Lost Valley Redoubt. She hasn't returned yet, so he asked me to go aid her.",
			'internalName' => "Q6609 HuntFathersFavor",
			'zoneId' => 1207,
			'zone' => "The Reach",
			'type' => 0,
		),
	6610 => array(
			'name'    => "Vateshran's Rites",
			'journal' => "The Rites Matron challenged me to complete the Vateshran's Rites within Vateshran Hollows. My success determines whether I earn the right to stay in the Reach.",
			'internalName' => "DUN-VR Vateshran'sRites Norm",
			'zoneId' => 1227,
			'zone' => "Vateshran Hollows",
			'type' => 5,
		),
	6613 => array(
			'name'    => "An Abundance of Stibbons",
			'journal' => "Lady Clarisse Laurent's manservant Stibbons broke a relic in a nearby xanmeer and unleashed a curse. Now the Sithis priest Somarz demands that she make things right. With Stibbons somehow incapacitated, Lady Laurent needs help.",
			'internalName' => "BW-GL Glenbridge",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	6614 => array(
			...
			'journal' => "Vandacia and the Order of the Waking Flame seem to be determined to attack Gideon and capture the Ambitions. Governor Keshu promised to protect them, but wants to take them somewhere more defensible than the city. Somewhere such as Fort Redmane.",
			'internalName' => "BW6",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6619 => array(
			...
			'journal' => "With the twins safely under the protection of Keshu's Black Fin Legion, Eveli and I need to figure out how to find the other Ambitions before Vandacia and his cultists beat us to it.",
			'internalName' => "BW4 Q6619 Start",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	6620 => array(
			'name'    => "The Rising Winds",
			'journal' => "A resident of the Stonewastes named Nuxul explained that his village was attacked by a warlord named Naxhosa who stole their supplies. Nuxul asked me to help him find the remaining Three Winds, famous Argonian protectors, and ask for their help.",
			'internalName' => "Q6620 Stonewastes",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	6623 => array(
			...
			'journal' => "A priest of Zenithar asked me to help him locate a lost artifact of his faith, the Golden Anvil, in Zenithar's Abbey.",
			'internalName' => "U30 Z Hollow Quest",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	6624 => array(
			'name'    => "Idol Threats",
			'journal' => "An Argonian named Jela asked for my help to rescue her friends from the Sul-Xan, a dangerous tribe that seeks to use them to summon a spirit of destruction using something called the Idol of Xulunaht.",
			'internalName' => "Q6624 Bestowal",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	6630 => array(
			'name'    => "A Hidden Vault",
			'journal' => "Eveli Sharp-Arrow asked me to accompany her to Gideon as we run down the clue provided by the deciphered Imperial documents and try to find the hidden vault that contains the Four Ambitions.",
			'internalName' => "BW3 - A Hidden Vault",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	6632 => array(
			'name'    => "The King's Spoils",
			'journal' => "<<1>> needs help gathering fermented mubcrab apples to brew into a special festival cider of her own design. They have all been harvested for King Boar in the Festival Arena and I'll need to compete with the hungry boar to get them.",
			'internalName' => "Q6632 Kings Spoils Bestowal",
			'zoneId' => 0,
			'zone' => "",
			'type' => 12,
		),
	6634 => array(
			'name'    => "The Ghostwriter of Giovesse",
			'journal' => "A romance novelist named Yisara asked me to help her explore the haunted Castle Giovesse. She seems convinced that the castle's tragic history will help inspire her next novel.",
			'internalName' => "Q6634 Gideon",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	6637 => array(
			...
			'internalName' => "Q6637 Vunalk Ruins",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6641 => array(
			'name'    => "Wisdom of the Druids",
			'journal' => "I met a Stonelore Circle druid named Jend. He's worried about the recent activity around the volcanic vents in the nearby area. He asked me to help investigate said vents and find a solution to the problem.",
			'internalName' => "Q6641 Wisdom of the Druids",
			'zoneId' => 1318,
			'zone' => "High Isle",
			'type' => 0,
		),
	6645 => array(
			'name'    => "Legend of the Man-Bull",
			'journal' => "I learned that the Minotaur Bhrum-Koska is terrorizing an archeological site in southern Blackwood. I agreed to defeat Bhrum-Koska and remove any unearthed heirlooms that might be drawing Minotaurs to the area.",
			'internalName' => "Q6645 Group Boss1",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 1,
		),
	6652 => array(
			'name'    => "The Trophy-Taker",
			'journal' => "Xeemhok the Trophy-Taker, a brutal Argonian behemoth, lurks in the ruins near Vunalk. Dozens of brave warriors have challenged him and died. I agreed to take him on, and search the fallen for tokens by which they can be identified.",
			'internalName' => "Q6652 Group Boss6",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 1,
		),
	6658 => array(
			'name'    => "Making a Racket",
			'journal' => "The owners of the Happy Averno Shipping Company, Iulius and Scipion Averno, asked for my help dealing with a gang in Blackwood called the Fang-Furls.",
			'internalName' => "Q6658 Making a Racket",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	6661 => array(
			'name'    => "Haunted Legacy",
			'journal' => "The people of Gideon believe that a woman named Cerise Gemain murdered a beloved priestess sixty years ago, but her grandson, Faric, insists she's innocent of the charges. He enlisted me to help him prove it.",
			'internalName' => "Q6661 HauntedLegacy",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	6662 => array(
			'name'    => "Things Lost, Things Found",
			'journal' => "",
			'internalName' => "CPN_Bastian 01",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 16,
		),
	6665 => array(
			'name'    => "Shadow Tactics",
			'journal' => "<<1>>'s client heard rumors of ancient caches containing old information about the Morag Tong in Bloodrun Cave. I need to go to Bloodrun Cave, find the documents, and destroy them on behalf of the client.",
			'internalName' => "Q6665 Bloodrun Solo Daily",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	6667 => array(
			'name'    => "Dead Weight",
			'journal' => "Mirri remains concerned about her mother's obsession with finding her father's stolen puzzle box. Mirri believes it's only a matter of time before Irenni goes searching again, so she wants to take up the search herself.",
			'internalName' => "CPN Mirri Quest 02",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 16,
		),
	6670 => array(
			'name'    => "The Pirate's Gift",
			'journal' => "I found a message written by a pirate of the Topal Bay in a bottle by the shore. It appears to be directions to buried treasure.",
			'internalName' => "Q6670 PiratesGift",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	6675 => array(
			'name'    => "Insect Savior",
			'journal' => "<<1>> asked me to enter <<2>> on behalf of a local bug enthusiast to bring back a special breed of torchbug before the cavern floods.",
			'internalName' => "Q6675 Undertow Solo Daily",
			'zoneId' => 1261,
			'zone' => "Blackwood",
			'type' => 0,
		),
	...
	6686 => array(
			'name'    => "Pledge: The Dread Cellar",
			'journal' => "<<1>> of the Undaunted has challenged me to explore the Dread Cellar.",
			'internalName' => "u31-DUN2 Pledge",
			'zoneId' => 0,
			'zone' => "",
			'type' => 15,
		),
	6693 => array(
			...
			'journal' => "Mehrunes Dagon has been defeated and his plot to take over Tamriel has been thwarted. Eveli thinks we need to check in with our allies and rendezvous in Leyawiin.",
			'internalName' => "DLCEP",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
	...
	6694 => array(
			'name'    => "Peace's Wretched Price",
			'journal' => "Tephilaz, a Daedra living in Wretched Spire, died suddenly on the street. The locals suspect someone murdered him to stop a treaty. A Dremora named Noroth seeks the killer before more violence erupts.",
			'internalName' => "Q6694 Wretched Spire",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
		),
	6695 => array(
			'name'    => "Plucking the Crow",
			'journal' => "Witchmother Taerma asked for my help to defeat a Wraith-of-Crows from the Evergloam called the Crowborne Horror. She tasked me with collecting feathers from vile creatures in order to form an effigy that can bring the creature forth.",
			'internalName' => "Q6695 WF Plucking the Crow",
			'zoneId' => 0,
			'zone' => "",
			'type' => 12,
		),
	6697 => array(
			'name'    => "Ambition's End",
			'journal' => "Sombren decided to join Mehrunes Dagon. He stole Calia's power and added it to his own. Now we must protect the Anchorite and figure out how to find and use the egonymic if we hope to defeat Sombren and Mehrunes Dagon.",
			'internalName' => "DLC2 Start",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	6707 => array(
			...
			'journal' => "We destroyed an Incarnate at Burning Gyre Keep, but Lyranth believes that the Waking Flame plans to create more. She wants to find the Riven Cataclyst before they do-and she thinks the Bladebearer Dremora can point us to our goal.",
			'internalName' => "Q6707 DL03",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	6708 => array(
			'name'    => "Born of Grief",
			'journal' => "The mad prisoner Elegian, creator of the Riven Cataclyst, told me we can get to the device by going to Annihilarch's Summit. I need to locate the cataclyst before Sister Celdina unleashes more Incarnates to attack Fargrave and Nirn.",
			'internalName' => "Q6708 DL04",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	6709 => array(
			'name'    => "Mercenary in the Making",
			'journal' => "I found a notice that says House Hexos in Fargrave seeks adventurers for dangerous work.",
			'internalName' => "Q6709-DL-Daily Vector",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	6710 => array(
			...
			'internalName' => "Q6710 DL Solo Daily 1",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	6711 => array(
			'name'    => "Brandfire Reformatory Relics",
			'journal' => "Luna Beriel tasked me with recovering relics from the Brandfire Reformatory, a fearsome building in the Deadlands where the Waking Flame cult takes prisoners and doesn't release them.",
			'internalName' => "Q6711 DL Solo Daily 2",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	6712 => array(
			'name'    => "Forgotten Grave Goods",
			'journal' => "Luna Beriel has witness accounts of some valuables lying in the False Martyrs' Folly from when the Martyrs there were turned to stone. She wants me to go to the Folly and bring the items back.",
			'internalName' => "Q6712 DL Solo Daily 3",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	6713 => array(
			'name'    => "Flowers in the Folly",
			'journal' => "Luna Beriel tasked me with going into the False Martyrs' Folly to retrieve some martyrs' copperleaf plants for Tuleenith, a healer in Fargrave.",
			'internalName' => "Q6713 DL Solo Daily 4",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	6714 => array(
			'name'    => "Clandestine Communications",
			'journal' => "Luna Beriel gave me some papers containing important information from the Gleaners founder, Pieron Desant. The letters need to be dropped in letterboxes throughout the Blood Pit for the Gleaners' agents imprisoned there.",
			'internalName' => "Q6714 DL Solo Daily 5",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 0,
		),
	6717 => array(
			'name'    => "The Mind's Eye",
			'journal' => "Vaveli Indavel asked me to place seeing stones around the den of the Unmaker and kill the creature on the behalf of Vares Dredayn, who is studying the creature's death cycle.",
			'internalName' => "Q6717 Infernium Group Daily 2",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 1,
		),
	6718 => array(
			...
			'internalName' => "Q6718 Infernium Group Daily 3",
			'zoneId' => 1286,
			'zone' => "The Deadlands",
			'type' => 1,
		),
	6722 => array(
			...
			'internalName' => "Q6722 U33 Jesters Fest Musical",
			'zoneId' => 41,
			'zone' => "Stonefalls",
			'type' => 12,
		),
	...
	6752 => array(
			...
			'journal' => "Lady Arabelle Davaux needs help investigating a mystery that threatens a crucial conference to be held on High Isle, in the Systres Archipelago.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6753 => array(
			...
			'journal' => "The Ascendant Order wrecked the ships carrying the alliance leaders to High Isle, but they were not washed ashore. Lady Arabelle believes that our best chance to find the missing delegates is to investigate the Order and learn who's behind this.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6754 => array(
			...
			'journal' => "We found a map at Castle Navire that shows several possible meeting sites used by the Ascendant Order. Lady Arabelle believes investigating these sites is our best chance to track down the missing alliance leaders.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6757 => array(
			'name'    => "Scalding Scavengers",
			'journal' => "A High Elf named Vinilsare asked me to escort her through the Firepot, a dangerous cavern, to collect vulk'esh scoria and ensure her wife, Tarrinore's, safety.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6767 => array(
			'name'    => "Race for Honor",
			'journal' => "Cynric, the ghostly guardian of Garick's Rest, challenged me to complete three Trials of Worth. He wants me to honorably earn Lady Garick's Sacred Shield before the necromancer Amunara steals it.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6772 => array(
			'name'    => "An Experiment with Peace",
			'journal' => "A strange malady is affecting the patients of Steadfast Manor. The healers are lost on how to treat it. If I find the cause, perhaps they can determine a solution.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6773 => array(
			'name'    => "The Missing Prowler",
			'journal' => "Captain Jimila has lost her ship, the Prowler. She and her quartermaster, Oblan, discovered it missing after coming ashore for supplies. I agreed to help find the ship so they can get off Skulltooth Coast.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6778 => array(
			'name'    => "Aiding the Archipelago",
			'journal' => "I found a notice for adventurers seeking work on the islands of High Isle and Amenos. Sounds right up my alley.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6781 => array(
			...
			'journal' => "We defeated the Ascendant Magus at All Flags Islet and saved the alliance leaders. Lady Arabelle believes there's still a chance to salvage Lord Bacaro's peace talks.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6783 => array(
			'name'    => "Reavers of the Reef",
			'journal' => "Admiral Galvendier of the Dufort Flotilla requires soldiers for an assault on the Dreadsail pirate fleet's headquarters.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6784 => array(
			...
			'journal' => "I met a sailor recruiting for war against the Dreadsail pirate fleet. I agreed to join a landing party for a mission.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6794 => array(
			'name'    => "Rhadh's Map Fragment",
			'journal' => "I found the body of a Redguard, Rhadh. It looks like he died before retrieving a map for <<1>> at the Dufort Shipyards.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6799 => array(
			...
			'journal' => "A new card game called Tales of Tribute has captured the imagination of cardsharps and collectors all across Tamriel. I can begin my own Tribute journey in Gonfalon Bay.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6800 => array(
			...
			'journal' => "The Gonfalon Chapter's daily broker, Kishka, challenged me to seek out rival Tribute players and defeat them. If I succeed, I will earn both rank and rewards!",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6803 => array(
			'name'    => "Avarice of the Eldertide",
			'journal' => "A pair of Eldertide theurges have taken control of a local lord's land, searching it for magical geodes. I need to defeat the theurges and collect the geodes they've unearthed.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6805 => array(
			'name'    => "A Final Peace",
			'journal' => "An old knight of the Order of the Albatross wants someone to brave the ruins of Death's Valor Keep and retrieve the skulls of the knights who fell there long ago so they can finally be put to rest.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6813 => array(
			'name'    => "Venting the Threat",
			'journal' => "Druid Peeska is worried about the increasing volcanic activity at the volcanic vents on the island. She hired me to gather allies and disrupt the activity before the volcanic vents can erupt and the situation becomes dire.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6816 => array(
			'name'    => "The Serpent Caller",
			'journal' => "A Sea Elf fanatic named Serpent Caller Vinsha is manipulating snakes native to High Isle, magically altering them to make them more dangerous. The Stonelore Circle druids want her stopped.",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
	...
	6832 => array(
			'name'    => "Dueling Tributes",
			'journal' => "The Gonfalon Chapter's daily broker, Marunji, challenged me to seek out adventurers like myself and defeat them in Tales of Tribute. If I succeed, I will earn both rank and rewards!",
			'internalName' => "",
			'zoneId' => 0,
			'zone' => "",
			'type' => 0,
